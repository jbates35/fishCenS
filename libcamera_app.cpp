...
//    char tuning_file[] = "/usr/local/share/libcamera/ipa/raspberrypi/imx708_wide.json";
//
//    setenv("LIBCAMERA_RPI_TUNING_FILE", tuning_file, 1);
...
void LibcameraApp::ConfigureViewfinder()
{
    ...
    // Now we get to override any of the default settings from the options_->
    configuration_->at(0).pixelFormat = libcamera::formats::RGB888;
    //configuration_->at(0).pixelFormat = libcamera::formats::SRGGB10_CSI2P;
...
//		}
//	}
	std::cout << "SET FRAMERATE IS: " << options_->framerate << "\n";
    int64_t frame_time = 1000000 / options_->framerate; // in us
			controls_.set(25,
						  libcamera::Span<const int64_t, 2>({ frame_time, frame_time }));

//    controls.set(controls::FrameDuration, )
